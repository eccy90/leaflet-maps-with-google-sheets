      ...
      if (point.Latitude !== '' && point.Longitude !== '') {
        var marker = L.marker([point.Latitude, point.Longitude], {icon: icon})
          ...
          (point['Image'] ? ('<img src="' + point['Image'] + '"><br>') : '') + '<b>Ward: </b>'+
                     point['Ward'] + '<br>' + '<b>Village: </b>' + point['Location'] + '<b>Operating Status:  </b>' +
                     point['Status'] + '<b>Type of Mining:  </b>' + point['Mining_Type'] + '<b>Is this site Registered?:  </b>' 
                     + point['Registration_Status'] + '<b>Registration Date:  </b>' + point['Registered_Date'] 
